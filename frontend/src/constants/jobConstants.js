...
export const JOB_CREATE_APPLIED_REQUEST = 'JOB_CREATE_APPLIED_REQUEST';
export const JOB_CREATE_APPLIED_SUCCESS = 'JOB_CREATE_APPLIED_SUCCESS';
export const JOB_CREATE_APPLIED_FAIL = 'JOB_CREATE_APPLIED_FAIL';

export const JOB_SEARCH_RESET = 'JOB_SEARCH_RESET';
